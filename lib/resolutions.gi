...
DeclareGlobalVariable( "ENOUGH_PROJECTIVES_IBJECTIVES_METHODS" );

InstallValue( ENOUGH_PROJECTIVES_IBJECTIVES_METHODS, rec( 
...
CAP_INTERNAL_ENHANCE_NAME_RECORD( ENOUGH_PROJECTIVES_IBJECTIVES_METHODS );

CAP_INTERNAL_INSTALL_ADDS_FROM_RECORD( ENOUGH_PROJECTIVES_IBJECTIVES_METHODS );
